...
class TimeLine2static extends StatelessWidget {
  TimeLine2static({super.key, required this.query, required this.itenary});
  final String query;
  final DayWiseModel itenary;
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      ...
                                      children: [
                                        ...
                                        Text(itenary.items![i].name!,
                                            style: GoogleFonts.poppins(
                                              textStyle: TextStyle(
                                                  color: Colors.white,
                                                  fontWeight: FontWeight.bold),
                                            )),
                                        Text(itenary.items![i].task!,
                                            style: GoogleFonts.poppins(
                                              textStyle:
                                                  TextStyle(color: Colors.grey),
                                            )),
                                        Text(itenary.items![i].time!,
                                            style: GoogleFonts.poppins(
                                              textStyle:
                                                  TextStyle(color: Colors.grey),
                                            )),
